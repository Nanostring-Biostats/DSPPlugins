...
main <- function(dataset, segmentAnnotations, targetAnnotations, outputFolder) {
  ...
  normfactors = compute_normalization_factors(segmentAnnotations = segmentAnnotations, 
  ...
  pdf(file = file.path(outputFolder, "signal_qc.pdf", fsep = .Platform$file.sep), 
...
assign_colors <- function(annot) {
  ...
  colvec = c('#E41A1C','#377EB8','#4DAF4A','#984EA3','#FF7F00','#FFFF33','#A65628','#F781BF','#999999',
